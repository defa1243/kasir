...
<table id="example1" class="table table-bordered table-striped">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?= $x['information'] ?></td>
            <td>
                <a class="btn btn-success text-light" href="javascript:void(0)"
                    onclick="editModal(<?= $x['id_menu'] ?>)"><i class="fas fa-pencil-alt mr-2"></i></i>Edit</a>
                <a class="btn btn-danger text-light" href="javascript:void(0)"
                    onclick="deleteData(<?= $x['id_menu'] ?>)"><i class="fas fa-trash-alt"></i>Delete</a></td>
        </tr>
        <?php } ?>
    </tbody>
</table>
